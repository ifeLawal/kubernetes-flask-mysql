...
4) The Flask API can be ran locally for testing. Just [install and run](https://dev.mysql.com/doc/mysql-getting-started/en/) mysql locally, but requires installing mysqlclient in your python virtualenv
## Prerequisites
